...
namespace GPUInstancer
{
    ...
    public static class GPUInstancerConstants
    {
        ...
        public static readonly string FOLIAGE_SHADER_URP_PACKAGE_PATH = "Extras/GPUI_Foliage_URP_Support.unitypackage";
        public static readonly string FOLIAGE_SHADER_HDRP_PACKAGE_PATH = "Extras/GPUI_Foliage_HDRP_Support.unitypackage";
        ...
        public static readonly string ERRORTEXT_shaderGraph = "{0} is created with ShaderGraph, and GPUInstacer Setup is not present. Please copy the shader code and paste it to a new shader file. When you set this new shader to your material, GPUI can run auto-conversion on this shader.";
