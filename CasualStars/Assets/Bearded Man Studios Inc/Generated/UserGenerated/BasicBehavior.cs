...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class BasicBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (BasicNetworkObject)obj;
		...
		{
			Initialize(new BasicNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new BasicNetworkObject(networker, this, createCode, metadata);
		}
