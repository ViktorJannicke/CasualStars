...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class NetworkedGameManagerNetworkObject : NetworkObject
	{
		...
		public NetworkedGameManagerNetworkObject() : base() { Initialize(); }
		public NetworkedGameManagerNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public NetworkedGameManagerNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
